...
const NGOCampaignForm = ({ navigation }) => {
  ...
  const validate = (values) => {
    ...
    } else if (values.campaignTitle.trim().split(/\s+/).length < 2) {
      errors.campaignTitle = "Campaign title must contain at least 2 words"
    }
    ...
    if (!values.fullDescription) {
      ...
      errors.fullDescription = "Full description must be at least 30 characters"
    }
            ...
            <>
              ...
              <View style={styles.inputContainer}>
                ...
                {errors.campaignTitle && touched.campaignTitle && (
                  <Text style={styles.errorText}>{errors.campaignTitle}</Text>
                )}
              </View>
              ...
              <View style={styles.inputContainer}>
                ...
                {errors.fullDescription && touched.fullDescription && (
                  <Text style={styles.errorText}>{errors.fullDescription}</Text>
                )}
              </View>
